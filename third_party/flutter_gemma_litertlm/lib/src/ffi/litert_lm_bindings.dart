...
class LiteRtLmBindings {
  ...
  // Local Android adapter. The native API takes ownership of this descriptor.
  ffi.Pointer<LiteRtLmEngineSettings> settingsFromFileDescriptor(
    int fd, ffi.Pointer<ffi.Char> backend, ffi.Pointer<ffi.Char> vision,
    ffi.Pointer<ffi.Char> audio,
  ) => _settingsFromFileDescriptor(fd, backend, vision, audio);

  late final _settingsFromFileDescriptor = _lookup<ffi.NativeFunction<
      ffi.Pointer<LiteRtLmEngineSettings> Function(ffi.Int, ffi.Pointer<ffi.Char>,
          ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)>>(
      'litert_lm_engine_settings_create_from_raw_file_descriptor')
      .asFunction<ffi.Pointer<LiteRtLmEngineSettings> Function(int,
